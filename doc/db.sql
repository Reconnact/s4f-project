...
create table resetpassword(resetID int auto_increment, profileID int, password varchar(255), PRIMARY KEY(resetID), FOREIGN KEY(profileID) REFERENCES profile(profileID));